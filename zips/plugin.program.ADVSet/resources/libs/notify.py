...
def autoConfig(msg='', TxtColor='0xFFFFFFFF', Font='font12', BorderWidth=10):
	class MyWindow(xbmcgui.WindowDialog):
		...
		def __init__(self,msg='',L=0,T=0,W=1280,H=720,TxtColor='0xFFFFFFFF',Font='font12',BorderWidth=10):
			...
			msg3 = "[B][COLOR %s]Numero de bytes usados para el buffer en la memoria.  Cuando se establece en [COLOR %s]0[/COLOR] la cache se escribira en el disco en lugar de en la RAM.  Aviso: Para el valor establecido aqui, Kodi necesitara el triple para funcionar bien. Poner una cifra demasiado alta puede provocar bloqueo el de Kodi si no existe suficiente RAM libre(1/3 de Memoria libre: [COLOR %s]%s[/COLOR])[/COLOR][/B]" % (COLOR2, COLOR1, COLOR1, freeMemory)
			...
			msg3 = "[COLOR %s][B]curlclienttimeout[/B] Es el tiempo de espera en segundos en que libcurl intentara conectar y [B]curllowspeedtime[/B] es el tiempo en segundos que libcurl considera una conexion de baja velocidad.  Para conexiones mas lentas configurelo en 20.[/COLOR]" % COLOR2
